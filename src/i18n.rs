...
fn en(key: &str) -> &'static str {
    match key {
        ...
        "alias.import_conflict_title" => "Alias already exists",
        "alias.import_conflict_msg" => "{} aliases already exist. Overwrite all of them?",
        "alias.import_skipped" => "Skipped {} existing aliases",
        "alias.import_success_detail" => "Imported {} new, skipped {} existing",
...
fn zh(key: &str) -> &'static str {
    match key {
        ...
        "alias.import_conflict_title" => "别名已存在",
        "alias.import_conflict_msg" => "有 {} 个别名已存在，是否全部覆盖？",
        "alias.import_skipped" => "已跳过 {} 个已存在的别名",
        "alias.import_success_detail" => "新增 {} 个，跳过已存在 {} 个",
